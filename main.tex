...
executable visual tools for perceptual ones. The visual tools are gated by learned
applicability conditions, and both capability types accumulate in a persistent library.
