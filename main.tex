...
inference on all 20 model--benchmark settings (avg.\ $+4.7$ acc). The same framework extends to a
tool-mastery setting with a pre-provided tool set, where mastery profiling lifts
step-level tool selection across all tested backbones. Against task-specific RL (VTool-R1, DeepEyes), \sysname{}
