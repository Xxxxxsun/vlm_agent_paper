# Final Table, updated 2026-05-18
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| Qwen2.5-VL-3B | Baseline | 74.78 | 65.79 | 71.20 | 79.00 | 48.25 | 63.62 | - |
| Qwen2.5-VL-3B | Focus skill + zoom tool | 86.09 | 81.58 | 84.29 | 89.50 | 51.50 | 70.50 | V* +13.09, HR +6.88 |
...
| --- | --- | --- |
| 3B | Baseline V* | `results/qwen25vl7b_agent_results/qwen25vl3b_baseline_3b_baseline_vstar_20260518_121644` |
...
- 3B baseline combines the V* baseline run from 2026-05-18 and the HRBench4K baseline run from 2026-05-17.
- 7B V* focus was re-judged with the official LLM judge on 2026-05-18 and matched the earlier local fused score.
