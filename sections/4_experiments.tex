...
We compare \sysname{} against task-specific RL on three task families using two
Qwen2.5-VL backbones (3B, 7B): Chart and Table reasoning under the VTool-R1
protocol~\citep{DBLP:journals/corr/abs-2505-19255}, and high-resolution V$^\star$ and
HRBench4K under the DeepEyes protocol~\citep{DBLP:journals/corr/abs-2505-14362}.
...
Appendix~\ref{app:impl} for the per-benchmark token totals). Across these three task
