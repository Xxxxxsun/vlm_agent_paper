...
capability storage. The full mechanism table, per-ablation discussion, and sensitivity
curves are deferred to Appendix~\ref{app:ablation_mechanisms} for space.
