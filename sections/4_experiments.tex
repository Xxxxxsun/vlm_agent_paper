...
capability-type comparison. We ablate six mechanisms inside the evolution loop: generic
prompting vs.\ evolved capability, failure-only vs.\ both-correct-and-incorrect diagnosis,
text-only vs.\ multimodal diagnosis, single-candidate vs.\ multi-candidate exploration,
unpaired vs.\ paired mastery skill at tool invocation, and per-case vs.\ persistent
capability storage. Appendix~\ref{app:ablation_mechanisms} reports the completed
artifact-backed HRBench mechanism probe, plus a matched 200-case rerun audit for the
