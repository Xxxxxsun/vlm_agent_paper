...
baseline~\citep{xskill_2024} that injects a generic visual-reasoning skill header on top
...
\caption{%
  ...
  \emph{XSkill-style}~\citep{xskill_2024} generic-skill-injection baseline. XSkill-style
