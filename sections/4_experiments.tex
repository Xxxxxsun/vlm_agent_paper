...
as the new dominant family. The replay reuses completed per-case outputs, isolating the
adaptation policy from the cost of regenerating capabilities online. We compare \emph{Direct} (no capabilities), \emph{Static} (capabilities evolved
