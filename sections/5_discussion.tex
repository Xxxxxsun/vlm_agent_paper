...
The bottleneck analysis in Section~\ref{sec:bottleneck} suggests a practical diagnostic:
...
We report results at $N{=}3$ iterations; Section~\ref{sec:dynamics} suggests gains plateau
