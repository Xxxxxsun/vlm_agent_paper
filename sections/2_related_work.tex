...
SFT and/or RL with curated trajectories to teach VLMs to invoke a fixed tool inventory.
...
Lever~LM~\citep{DBLP:conf/nips/YangPMXZHZ24} configures in-context example sequences to
leverage VLMs without retraining. A parallel program-synthesis line composes hand-curated
...
EcoAlign~\citep{DBLP:journals/corr/abs-2511-11301} frames the cost of adapting VLMs efficiently.
