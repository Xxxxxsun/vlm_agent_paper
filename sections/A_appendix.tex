...
\caption{%
  ...
  Table~\ref{tab:evolution_full}. Blank cells indicate runs whose results have not yet been
  inserted and are excluded from aggregate statements; the Full row reproduces the
  Skill~$+$~Tool entry of Table~\ref{tab:evolution_full} for reference.
}
