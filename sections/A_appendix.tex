...
\noindent\textbf{Generated skill} (paired with the tool below; triggered on ChartQA):
\begin{lstlisting}[style=appendixsnippet, frame=single, framesep=4pt, framerule=0.4pt]
...
\noindent\textbf{Generated tool} (paired with the skill above):
\begin{lstlisting}[style=appendixsnippet, frame=single, framesep=4pt, framerule=0.4pt]
