...
\For{$n = 1$ \KwTo $N$}{
  ...
  $\{(s_m, t_m)\}_{m=1}^{M} \leftarrow \textsc{Generator}(a, r;\, \pi_\theta)$\;
  ...
  \If{accuracy improves}{
    ...
    $t_{m^\star}.\text{mastery} \leftarrow \textsc{Mastery}(t_{m^\star}, \mathcal{D}_{\text{train}};\, \pi_\theta)$\;
  }
}
\Return{$\mathcal{C}$}\;
...
implement complementary aspects of failure-driven capability evolution rather than redundant
