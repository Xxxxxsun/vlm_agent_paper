...
labeled training subset, with the \textsc{AnalyzerDecider} choosing on each case whether
...
structured-VQA gap, and composes additively with RL when both are available. Together,
these results suggest that a substantial part of task-specific VLM adaptation can be
obtained without any gradient updates: capability evolution can serve as a lightweight
alternative when labels or feedback signals are available, and as a complementary
component when task-specific RL training is also feasible.
