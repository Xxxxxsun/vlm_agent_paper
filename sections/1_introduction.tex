...
\begin{figure}[t]
  ...
  \caption{
    \textbf{SFT/RL vs.\ \sysname{}.}
    Top: typical per-task SFT/RL pipelines retrain weights for each new task family.
    Bottom: \sysname{} evolves a task-family-specific skill and tool set from a small
    labeled training subset, with the VLM frozen.
  }
