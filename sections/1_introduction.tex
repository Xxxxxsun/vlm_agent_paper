...
\begin{enumerate}[leftmargin=*, label=(\arabic*), noitemsep]
  \item A \textbf{problem formulation} that recasts per-task VLM adaptation as labor-free
        capability evolution: a frozen agent builds its own task-family-specific skill and
        tool set from a small training subset, replacing manual SFT data curation and
