...
We instantiate this idea in \sysname{}, a framework that evolves two complementary
capability types from a small labeled training subset and dynamically equips them at
inference, without any weight updates or task-specific prompt engineering. \textbf{Skills} are
...
\begin{enumerate}[leftmargin=*, label=(\arabic*), noitemsep]
  ...
  \item \textbf{Empirical evidence} across four visual-reasoning benchmarks, six VLM
        ...
        showing that capability evolution can match or complement task-specific RL without
        any weight updates.
\end{enumerate}
