...
benchmarks plus GTA and the VTool-R1 / DeepEyes splits. Other modalities
...
experiments use ground-truth from the benchmark splits as this signal, which
...
require a confidence-based or self-consistency-based feedback substitute that leave
to future work.
